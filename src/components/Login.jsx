...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Assuming a successful login if response status is 200
      if (response.status === 200) {
        ...
        // Display error toast for unexpected response status
        toast.error("Unexpected response from the server.");
      }
    } catch (error) {
      // Display error toast with a user-friendly message
